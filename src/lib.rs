...
impl Tables
{
    ...
    {
        let temp : std::mem::MaybeUninit<
                       bindings::table_collection> = std::mem::MaybeUninit::uninit();
...
impl TreeSeq
{
    ...
    {
        let temp : std::mem::MaybeUninit<
                       bindings::tree_sequence> = std::mem::MaybeUninit::uninit();
